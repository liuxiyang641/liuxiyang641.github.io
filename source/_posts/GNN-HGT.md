...
![image-20210414152012151](image-20210414152012151.png)

整体结构：

![image-20210414163111880](image-20210414163111880.png)

注意这里，A-Linear是根据node $t$的type决定的。同时使用了残差结构。

聚合函数就是直接相加。

![image-20210414163415151](image-20210414163415151.png)

核心是两部分，产生消息，然后产生注意力。

产生消息：

![image-20210414163541401](image-20210414163541401.png)

邻居node的type和邻居relation的type的weight相乘。

产生attention：

![image-20210414163722393](image-20210414163722393.png)
...
![image-20210414170312971](image-20210414170312971.png)

最后加到邻居node $s$的表表示$H[s]$上。

![image-20210414170336206](image-20210414170336206.png)
...
<img src="image-20210414180544283.png" alt="image-20210414180544283" style="zoom: 33%;" />
